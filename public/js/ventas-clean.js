...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('✅ Todas las funciones de búsqueda están disponibles:');
    console.log('- buscarProducto()');
    console.log('- buscarProductoEnter()');
    console.log('- buscarProductoTiempoReal()');
    console.log('- generarTicketVenta()');
}); 