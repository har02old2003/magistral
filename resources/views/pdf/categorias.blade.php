...
<head>
    <meta charset="UTF-8">
    <title>Lista de Categorías - Farmacia Magistral</title>
    <style>
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $categoria->productos_count }}</td>
                <td>
                    @if($categoria->activo)
    ...
    <div class="footer">
        <p><strong>Farmacia Magistral</strong> - Sistema de Gestión de Categorías</p>
