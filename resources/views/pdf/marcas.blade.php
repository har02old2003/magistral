...
<head>
    <meta charset="UTF-8">
    <title>Lista de Marcas - Farmacia Magistral</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        th { background: #667eea; color: white; padding: 10px 8px; font-weight: bold; font-size: 10px; text-transform: uppercase; }
...
<body>
    <div class="header">
        <h1>🏷️ FARMACIA MAGISTRAL</h1>
        <h2>Lista de Marcas Registradas</h2>
    ...
    <div class="stats">
        ...
        <div class="stat-item">
            <div class="stat-number">{{ $con_productos }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $marca->productos_count }}</td>
                <td>
                    @if($marca->activo)
    ...
    <div class="footer">
        <p><strong>Farmacia Magistral</strong> - Sistema de Gestión de Marcas</p>
